    ...
    <div class="container navbar-container">
      ...
      <div v-if="showProfileMenu" class="profile-dropdown">
        ...
        <div class="profile-actions-section">
          <button @click="navigateToDeletedItems" class="profile-action-btn">
...
export default {
  ...
  methods: {
    ...
    navigateToDeletedItems() {
      console.log('Navigating to Deleted Items');
      this.showProfileMenu = false; // Close the profile dropdown
      this.$router.push('/deleted-items').catch(err => {
        console.error('Router navigation to deleted items failed:', err);
